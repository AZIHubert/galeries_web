...
describe('sendConfirmation', () => {
  ...
  describe('actions', () => {
    ...
    it('should fetch sendConfirmation success', () => {
      ...
      expect(actions[0].type).toEqual(`${SEND_CONFIRMATION} Fetch`);
      expect(actions[1].payload).toEqual({
        data: {
          status: 'pending',
        },
      });
      expect(actions[1].type).toEqual(`${SEND_CONFIRMATION} Set`);
      ...
      expect(actions[5].type).toEqual(`${SEND_CONFIRMATION} Set`);
    ...
    it('should fetch sendConfirmation global error', () => {
    ...
    it('should fetch sendConfirmation field error', () => {
