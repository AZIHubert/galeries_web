  ...
  describe('should show an error if', () => {
    describe('userName field', () => {
      it('is empty', async () => {
        ...
        expect(userNameError).toHaveTextContent('required field');
      });
    ...
    describe('email field', () => {
      it('is empy', async () => {
        ...
        expect(emailError).toHaveTextContent('required field');
      });
    ...
    describe('password field', () => {
      it('is empty', async () => {
        ...
        expect(passwordError).toHaveTextContent('required field');
      });
      it('contain spaces', async () => {
